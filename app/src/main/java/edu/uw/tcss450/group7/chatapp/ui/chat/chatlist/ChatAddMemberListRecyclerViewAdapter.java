...
public class ChatAddMemberListRecyclerViewAdapter extends RecyclerView.Adapter<ChatAddMemberListRecyclerViewAdapter.NewContactViewHolder> {
    ...
    public ChatAddMemberListRecyclerViewAdapter(List<Contact> items, ChatViewModel mModel, int chatId, String JWT) {
    ...
    public class NewContactViewHolder extends RecyclerView.ViewHolder {
        ...
        void setContact(final Contact contact) {
            ...
            binding.buttonSendRequest.setText("Add");
            binding.buttonSendRequest.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mChatsViewModel.connectAddUser(mChatId, mContact.getMemberId(), mJWT);
                }});
        }
    }
