...
import edu.uw.tcss450.group7.chatapp.databinding.FragmentChatMessageBinding;
    ...
    class MessageViewHolder extends RecyclerView.ViewHolder {
        ...
        void setMessage(final ChatMessage message) {
            ...
            if (mEmail.equals(message.getSender())) {
                ...
                String userName = message.getSender().split("@", 2)[0];
                binding.textMessage.setText(userName +
                        ": " + message.getMessage());
                ViewGroup.MarginLayoutParams layoutParams =
                        (ViewGroup.MarginLayoutParams) card.getLayoutParams();
